        ...
        <div class="layout-distribute-add">
            ...
            <Modal v-model="modalAdd" title="添加">
                ...
                <Form :model="info" label-position="right" :label-width="100">
                    <FormItem label="业务名称:">
                        <Input v-model="info.name" placeholder="请输入业务名称..."></Input>
                    </FormItem>
                    <FormItem label="下发来源:">
        ...
        <div class="layout-distribute-edit">
            <Modal v-model="modalEdit" title="修改分发业务信息">
                ...
                <Form :model="edit" label-position="right" :label-width="100">
                    <FormItem label="业务ID:">
                        <Input v-model="edit.id" disabled placeholder="请输入业务ID..."></Input>
                    </FormItem>
                    <FormItem label="业务名称:">
                        <Input v-model="edit.name" placeholder="请输入业务名称..."></Input>
                    </FormItem>
                    <FormItem label="下发来源:">
...
export default {
  ...
  methods: {
    ...
    modify (row) {
      ...
      this.edit = row
      this.id = row.id
      this.getCheckboxList2()
      this.getCheckboxList3()
      this.modalEdit = true
    },
    // 修改确定按钮
    editOk () {
