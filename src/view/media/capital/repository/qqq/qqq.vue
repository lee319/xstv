...
<template>
  <div class="layout-details">
    <div class="layout-details-img" @mouseenter="moun()" @mouseleave="moun1()">
      <div>
        <img :src="poster.url || 'http://static2.ptxstv.gitv.tv/upload/181205/png/16335130e9c5d29b1ea912fd24a3d6a8ae7062.png'"
          alt style="width:156px;height:216px;">
      </div>
      <div style="position:absolute;top:80px;right:55px;" @click="pushAddress()" v-if="modification">
        <span style="width:48px;height: 48px;background-color: #2d8cf0;display: block;text-align: center;padding-top:15px;border-radius:50%">
          <span style="margin-top:10px;color:#fff;">修改</span>
        </span>
      </div>
    </div>
    ...
    <div style="float: left;">
      ...
      <div style="margin-top:20px;">
        <div style="width:220px;height:135px;background-color: #fff;padding:5px;float: left" v-if="directors.length > 0">
          <Row>
            <Col span="6">
        ...
        <div style="width:220px;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.main_actors.length>0">
          <Row>
            <Col span="6">
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.main_actors" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="writers.length >0">
          <Row>
            <Col span="2">
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="actors.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in actors" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.hosts.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.hosts" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.guests.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.guests" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.commentators.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.commentators" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.dubbers.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.dubbers" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
        ...
        <div style="width:600px;;height:135px;background-color: #fff;padding:5px;float: left;margin-left:10px;" v-if="edit.person.teachers.length>0">
          <Row>
            <Col span="2">
            <span class="layout-details-font" style="position: relative;top:2px;">演员</span>
            </Col>
            ...
            <div style="margin-left:20px;float: left;" v-for="(p, key) in edit.person.teachers" :key="key">
              <img :src="p.portrait || 'http://static2.ptxstv.gitv.tv/upload/181205/png/163429a9c1b3df063b1e03c85ac6b63ec2beea.png'"
                alt style="width:60px;height:60px;border:1px solid #ffffff;border-radius: 50%;margin-top:10px;">
              <p style="text-align: center;">{{ p.name }}</p>
            </div>
    ...
    <div style="margin-top:30px;">
      ...
      <div class="layout-details-news">
        <div class="layout-details-font">
          <div v-for="item in basicNew" style="padding:5px 10px">{{item.value}}: {{item.show}}</div>
        </div>
      </div>
    </div>
    <!-- 运营信息 -->
        ...
        <Tabs v-if="sourceList.length > 0" :value="sourceList[0].id+''" @on-click="clickSubTab" type="card">
          <TabPane v-for="(item, key) in sourceList" :key="key" :label="item.src_name" :name="item.id+''">
            <Row>
              ...
              <span class="layout-details-font1">{{item.play_type_desc}}</span>
              </Col>
              <Col span="12" style="padding:5px 10px">
    ...
    <Modal v-model="showUpdateBaseInfoModel" title="修改基础信息" @on-ok="okUpdateBaseInfo" :width="50">
      <Form :model="baseInfo" label-position="right" :label-width="100">
        ...
        <FormItem label="官方网站:">
          <Input v-model="baseInfo.official_website"></Input>
        </FormItem>
        <FormItem label="上映时间:">
    ...
    <Modal v-model="showUpdateSourceInfoModel" title="修改播放来源信息" @on-ok="okUpdateSourceInfo">
      <Form :model="sourceEdit" label-position="right" :label-width="100">
        ...
        <FormItem label="节目特性:">
          <CheckboxGroup v-model="Is_play_feature" @on-change="hehehehhe">
        ...
        <FormItem label="来源详情ID:">{{ sourceEdit.play_id }}</FormItem>
    ...
    <!-- end 修改类型标签 -->
    <!-- 修改子集信息 -->
    <Modal v-model="showSubUpdateBaseInfoModel" title="修改子集信息" @on-ok="okSubUpdateBaseInfo" :width="50">
      <Form :model="subBaseInfo" label-position="right" :label-width="100">
        ...
        <FormItem label="播放方式:">
          <Select v-model="subBaseInfo.play_type" disabled>
            <Option :value="0">未知</Option>
            <Option :value="1">SDK</Option>
            <Option :value="2">APK</Option>
            <Option :value="1">CDN URL</Option>
          </Select>
        </FormItem>
        ...
        <FormItem label="是否付费:">
          <Select v-model="subBaseInfo.is_vip" disabled>
            <Option :value="0">否</Option>
            <Option :value="1">是</Option>
          </Select>
        </FormItem>
        <FormItem label="是否点播:">
          <Select v-model="subBaseInfo.is_tvod" disabled>
            <Option :value="0">否</Option>
            <Option :value="1">是</Option>
          </Select>
        </FormItem>
  ...
  export default {
    ...
    methods: {
        ...
        this.$http
          ...
          .then(response => {
            if (response.data.errno == 10000) {
              ...
              //基础信息
              this.edit.template.base_cloumns.forEach(val => {
                if (val.is_hidden == false) {
                  val.show = this.edit[val.key] || "";
                  this.basicNew.push(val);
                }
              });
              console.log(this.basicNew);
              ...
              if (
                ...
                this.sourceList.forEach(slv => {
                  // 是否会员付费1:是；0:否
                  if (slv.is_vip == 1) {
                    slv.is_is_vip = "是";
                  } else if (slv.is_vip == 0) {
                    slv.is_is_vip = "否";
                  }
                  ...
                  if (slv.status == 1) {
                    slv.is_status = "上线";
                  } else if (slv.status == 0) {
                    slv.is_status = "下线";
                  }

                  // sxtv下线状态 1上线0下线
                  if (slv.xstv_status == 1) {
                    slv.is_xstv_status = "上线";
                  } else if (slv.xstv_status == 0) {
                    slv.is_xstv_status = "下线";
                  }
                });
      ...
      showUpdateSourceInfo(item) {
        ...
        if (item.play_feature) {
          this.Is_play_feature = item.play_feature.split(";");
        } else {
          this.Is_play_feature = [];
        }
      ...
      okUpdateSourceInfo() {
        ...
        // this.sourceEdit.play_feature = this.sourceEdit.Is_play_feature;
        console.log(this.sourceEdit);
        self.$http
          .post(
            `${this.$config.BaseURL1}/media/v2/complete/program/source/modify`,
            {
              id: this.sourceEdit.id,
              resolution: this.sourceEdit.best_resolution,
              feature: this.Is_play_feature,
      ...
      removeTag(row) {
        console.log(row);
        this.$http
          .post(this.$config.BaseURL1 + "/media/v2/complete/program/tag/delete", {
            albumId: this.id * 1,
            tagId: row.tag_id
          })
          .then(response => {
      ...
      okPolymerRelieve() {
        this.$http
          .post(`${this.$config.BaseURL1}/media/v2/polymer/relieve`, {
      ...
      getTaglist() {
        console.log(this.edit);
        this.$http
          .get(this.$config.BaseURL7 + "/media/v2/xsmedia/taglist?id=" + this.id)
          .then(response => {
            if (response.data.errno == 10000) {
              console.log(response);
      ...
      getTagTreelist() {
        this.$http(
          ...
          "/media/v2/xstag/list?category_id=" +
          this.category_id
        ).then(response => {
          if (response.data.errno == 10000) {
      ...
      treeOkEdit() {
        ...
        this.$http
          .post(
            this.$config.BaseURL7 + "/media/v2/xsmedia/tagmodify",
            {
              id: this.id * 1,
              xs_tag: aidList.join(",")
            },
      ...
      getFilmList() {
        this.$http(
          this.$config.BaseURL1 +
          "/media/v2/complete/program/sakes/list?albumId=" +
          this.id +
          "&title=" +
          this.filmSearch.title +
          "&publish_year=" +
          this.filmSearch.publish_year +
          "&type=" +
          this.filmSearch.type +
          "&page=" +
          this.pageFilm +
          "&pageSize=" +
          this.pageSizeFilm
      ...
      getFilmAddList() {
        this.$http
          .get(
            ...
            this.filmSearchAdd.title +
            "&publish_year=" +
            this.filmSearchAdd.publish_year +
            "&type=" +
            this.filmSearchAdd.type +
            "&page=" +
            this.pageFilmAdd +
            "&pageSize=" +
            this.pageSizeFilmAdd
          )
          .then(response => {
            if (response.data.errno == 10000) {
              console.log(response);
      ...
      remove(row) {
        ...
        this.$http
          .post(
            this.$config.BaseURL1 + "/media/v2/complete/program/sakes/delete",
            {
              albumId: this.id * 1,
      ...
      onModalFilm() {
        ...
        this.$http
          .post(
            this.$config.BaseURL1 + "/media/v2/complete/program/sakes/modify",
            {
              albumId: this.id * 1,
              sakes_id: sakesIds
            }
      ...
      okModalEditTag() {
        ...
        this.$http
          .post(
            this.$config.BaseURL1 + "/media/v2/complete/program/tag/modify",
            this.EditTagRank
          )
          .then(response => {
            if (response.data.errno == 10000) {
