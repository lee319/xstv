        ...
        <div class="layout-address-search">
            <Form :model="search" inline>
                <FormItem label="节目集名称:" :label-width="80">
                    <Input v-model="search.albumId" style="width: 200px;" placeholder="请输入节目集名称..."></Input>
                </FormItem>
            </Form>
        </div>
        <!-- 添加 -->
        <div class="layout-address-add">
            <Button type="success" @click="modalAdd = true;info.ratio = 1;cutimgs=[]">添加</Button>
            <Modal v-model="modalAdd" title="添加" width="500" :styles="{top: '20px'}">
            ...
            <Modal v-model="modalAddCut" title="裁剪图片" fullscreen @on-ok="modalAddCutOnOk">
        ...
        <div class="layout-address-add">
            <Modal v-model="modalEdit" title="修改">
                <Form :model="edit" label-position="right" :label-width="100">
                    <FormItem label="节目集名称:">
                        <Input v-model="edit.input1"></Input>
                    </FormItem>
                    <FormItem label="海报比例:">
                        <Input v-model="edit.input2"></Input>
                    </FormItem>
                    <FormItem label="上传海报:">
...
<script>    
    ...
    export default {
        ...
        methods: {
            ...
            getTableList() {
                let self = this;
                self.$http(this.$config.BaseURL1 + '/media/v2/poster/address/list?albumId=' + 5).then(response => {
