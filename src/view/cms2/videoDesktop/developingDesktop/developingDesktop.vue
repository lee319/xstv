  ...
  <div id="template" class="layout-templateList">
          ...
          <div>
            <Row>
              ...
              <Poptip confirm title="确定要删除吗?" @on-ok="removeOk(tab)" @on-cancel="cancel(tab)">
                <Button type="error" size="small" style="margin-left:5px;!important;">删除</Button>
              </Poptip>
            </Row>
          </div>
        </Card>
    ...
    <div class="tmp-main" v-for="(item, index) in desktopinfo" :key="index"
      ...
      <div class="template16" v-if="item.template == 't16' && item.promotion.length > 0">
        ...
        <div style="clear: both;"></div>
        <div class="xstv-temp3-img" @click="infoModal(150,370,promotionOne,indexP,index)"
          v-for="(promotionOne,indexP) in item.promotion" :key="indexP" @mouseenter="changeLock(promotionOne,true)"
          @mouseleave="changeLock(promotionOne,false)">
          <div style="position:relative;">
            <img :src="promotionOne.imgUrl" width="370" height="150" alt="">
            <div style="position:absolute; z-index:2;top:0px;"
              v-if="typeof promotionOne.lock != 'undefined' && promotionOne.lock == true"
              @click.stop="onClickLock(promotionOne,indexP,index)">
              <div v-if="promotionOne.isLock == 0"
                style="color: #ffffff;height: 30px;width: 370px;background-color: #808695;font-size: 16px;text-align: center;line-height: 30px;margin-left:-5px; ">
                <span style="position: absolute;top: 0px;left: 20px;">
                  <Icon type="ios-unlock" />
                </span>
                <span>
      ...
      <div class="template17" v-if="item.template == 't17' && item.promotion.length > 0">
        ...
        <div class="xstv-temp3-img" @click="infoModal(150,370,promotionOne,indexP,index)"
          ...
          <div class="xstv-temp16-bgWenzi3" style='width:370px'>
            <p>{{promotionOne.title}}</p>
          </div>
        </div>
      </div>
                ...
                <Row>
                  ...
                  <div class="template">
                    ...
                    <div v-if="item._index == 16">
                      <p style="width:370px;height: 150px;"></p>
                      <p style="width:370px;height: 150px;"></p>
                      <p style="width:370px;height: 150px;"></p>
                    </div>
                    <!-- 模板17 -->
                    ...
                    <div v-if="item._index == 18" style='display:flex;'>
                      <Icon type="ios-search-outline"
                        style='font-size:40px;color:#fff;height:74px;line-height:74px;position:absolute;left:20px;z-index:99;' />
                      <div><input
                          style='width:637px;height:74px;border-radius:41px;border:0;position:relative;background:#ccc;padding-left:60px;font-size:26px;'
                          type="text" placeholder="搜索应用"></div>
