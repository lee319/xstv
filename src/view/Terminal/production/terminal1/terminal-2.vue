    ...
    export default {
        ...
        methods: {
            ...
            getTableList() {
                ...
                let search = JSON.parse(JSON.stringify(self.search));
                //时间转换
                search.startime = moment(self.search.startime).format(
                    "X"
                ) * 1 + '';
                search.endtime = moment(self.search.endtime).format(
                    "X"
                ) * 1 + '';
                let condition = JSON.stringify(search);
