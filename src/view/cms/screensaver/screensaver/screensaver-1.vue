    ...
    <div class="layout-screensaver">
            ...
            <Modal v-model="modalAdd" title="添加">
                ...
                <Form :model="info" label-position="right" :label-width="130" ref="info" :rules="ruleValidate">
                    ...
                    <FormItem label="图片地址:">
                        ...
                        <Upload :action="$config.BaseURLfile + '/common/upload/file'" ref="upload" :on-success="handleSuccess" :format="['jpg','jpeg','png']"
                    ...
                    <FormItem label="状态:" prop="status">
                        <Select v-model="info.status" style="width:360px" placeholder="请选择状态...">
                    ...
                    <FormItem label="广告投放开始时间:" prop="startTime">
                        <DatePicker type="date" placeholder="请选择广告投放开始时间..." style="width: 360px" v-model="info.IsstartTime"></DatePicker>
                    </FormItem>
                    <FormItem label="广告投放结束时间:" prop="endTime">
                        <DatePicker type="date" placeholder="请选择广告投放结束时间..." style="width: 360px" v-model="info.IsendTime"></DatePicker>
                    </FormItem>
                </Form>
            </Modal>
        </div>
            ...
            <div>
                <div style="padding:10px">
                    <Form :model="news" label-position="right" inline>
                        <FormItem label="广告ID:" :label-width="65">
                            <Input v-model="news.id" style="width: 100px;" disabled></Input>
                        </FormItem>
                        <FormItem label="展示顺序:" :label-width="70">
                            <Input v-model="news.orderNum" style="width: 100px;" disabled></Input>
                        </FormItem>
                        <FormItem label="该记录修改时间:" :label-width="100">
                            <Input v-model="news.updateTime" style="width: 150px;" disabled></Input>
                        </FormItem>
                        <FormItem label="图片地址:" :label-width="80">
                            <Input v-model="news.url" style="width: 300px;" disabled></Input>
                        </FormItem>
                        <FormItem label="开始投放时间:" :label-width="105">
                            <Input v-model="news.IsstartTime" style="width: 200px;" disabled></Input>
                        </FormItem>
                        <FormItem label="结束投放时间:" :label-width="90">
                            <Input v-model="news.IsendTime" style="width: 195px;" disabled></Input>
                        </FormItem>
                        <FormItem label="通用跳转参数:" :label-width="100">
                            <Input v-model="news.jump" style="width: 500px;" disabled type="textarea" :autosize="true"></Input>
                        </FormItem>
                    </Form>
                </div>
            </div>
        ...
        <Modal v-model="modalEdit" title="修改">
            ...
            <Form :model="edit" label-position="right" :label-width="130" ref="edit" :rules="ruleValidate1">
                ...
                <FormItem label="图片地址:">
                    <!-- <Input v-model="info.url"></Input> -->
                    <Upload :action="$config.BaseURLfile + '/common/upload/file'" ref="upload" :on-success="handleSuccess1" :format="['jpg','jpeg','png']"
                        :max-size="2048" :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize">
                        <Button icon="ios-cloud-upload-outline">上传图片</Button>
                    </Upload>
                </FormItem>
                ...
                <!-- 1 启动 2 停用 -->
                <FormItem label="状态:" prop="status">
                    <Select v-model="edit.status" style="width:360px" placeholder="请选择状态...">
                        <Option :value="1">启动</Option>
                        <Option :value="2">停用</Option>
                    </Select>
                </FormItem>
                ...
                <FormItem label="广告投放开始时间:" prop="startTime">
                    <DatePicker type="date" placeholder="请选择广告投放开始时间..." style="width: 360px" v-model="edit.IsstartTime"></DatePicker>
                </FormItem>
                <FormItem label="广告投放结束时间:" prop="endTime">
                    <DatePicker type="date" placeholder="请选择广告投放结束时间..." style="width: 360px" v-model="edit.IsendTime"></DatePicker>
                </FormItem>
            </Form>
        </Modal>
    </div>
