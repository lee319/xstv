    ...
    export default {
        ...
        methods: {
            ...
            getTableList() {
                ...
                self.$http(this.$config.BaseURL1 + '/media/topic/list?pageSize=' + self.pageSize + '&page=' + self.page + '&status=' + self.search.status + '&category_id=' + self.search.category_id + '&name=' + self.search.name).then(response => {
                    if (response.data.errno == 10000) {
                        console.log(response)
            ...
            getcontentList() {
                let self = this;
                self.$http(this.$config.BaseURL1 + '/media/topic/detail?topic_id=' + self.topicId + '&pageSize=' + self.pageSize1 + '&page=' + self.page1 + '&director=' + self.search2.director + '&year=' + self.search2.year).then(response => {
                    if (response.data.errno == 10000) {
                        console.log(response)
            ...
            getAddList() {
                let self = this;
                self.$http(this.$config.BaseURL1 + '/media/search?keywords=' + self.search1.keywords + '&page=' + self.page2 + '&pageSize=' + self.pageSize2 + '&cost_type=' + self.search1.cost_type + '&category_id=' + self.search1.category_id).then(response => {
                    if (response.data.errno == 10000) {
            ...
            editOk1(row) {
                ...
                //     return
                // }
                self.$http.post(this.$config.BaseURL1 + '/media/topic/videoreorder?topic_id=' + self.topicId + '&video_id=' + self.videoId1 + '&new_order=' + self.edit1.topic_order, self.edit1, {
