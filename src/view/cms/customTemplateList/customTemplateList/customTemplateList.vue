        ...
        <Card style="width:100%;background-color: #eeeeee;">
          <div>
            <Row>
              ...
              <Col span="6">创建时间:{{tab.addTime}}</Col>
  ...
  export default {
    ...
    methods: {
      ...
      tabChange(tab,index) {
        this.id = tab;
        this.tabId = tab;
        console.log(this.isRelease,'zhiqian')
        // console.log(this.tab.isRelease,'zhiqcian')        
        this.isRelease = tab;
        ...
        this.$http.get(this.$config.BaseURL + '/custompromotion/desktop/getdesktopinfo?id=' + tab).then(response => {
          ...
          if (response.data.errno == 10000) {
            ...
            // console.log(this.desktopinfo,'desktopinfo')
            console.log(tab,'tab')
            if(index == 1){
      ...
      getList() {
        ...
        self.$http.get(this.$config.BaseURL + '/custompromotion/desktop/list?customTemplateId=' + self.search.title).then(response => {
          ...
          if (response.data.errno == 10000) {
            ...
            console.log(this.tabs.isRelease,'chushi')
            console.log(this.tabs)
            
            if (this.tabs.length > 0) {
              this.tabChange(this.tabs[0].id,this.tabs[0].isRelease);
            }
          }
        }, response => {
      ...
      modalAddOk() {
        ...
        console.log(this.list_select_index,'当前下标');
        console.log(this.list[this.list_select_index],'长度');
        let promotion = [];
      ...
      release(tab) {
        ...
        self.$http.post(this.$config.BaseURL + '/custompromotion/desktop/release', {
          ...
          if (response.data.errno == 10000) {
            ...
            this.tabName = this.tabs[0].id + '';
            this.tabChange(tab);
            // console.log(this.isreleaseName,'isreleaseName')
